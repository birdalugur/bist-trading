...
result.to_csv(stats_name + '.csv')

#
# # Results >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
# stats_name = '_'.join(pair_name)
#
# df_columns = ['avg_duration', 'median_duration', 'number_trade', 'avg_cum_return_long', 'avg_cum_return_short',
...
#
# df_data = [
#     [avg_duration_s1, median_duration_s1, number_trade_s1, mean_return_ls1,
#      mean_return_ss1, mean_return_s1, median_short_s1, median_long_s1, median_last_total_return_s1],
#
#     [avg_duration_s2, median_duration_s2, number_trade_s2, mean_return_ls2,
